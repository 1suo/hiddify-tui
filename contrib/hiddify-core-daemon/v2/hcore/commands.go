...
// CurrentSystemInfo returns a one-shot core status sample for the daemon
// control surface without exposing the legacy TCP service.
func CurrentSystemInfo() *SystemInfo {
	return static.readStatus(nil)
}
